...
public class StudentsUpdateDeleteFrame extends JFrame {
    ...
    // Wiring
    private final IStudentDAO teacherDAO = new StudentDAOImpl();
    private final IStudentService teacherService = new StudentServiceImpl(teacherDAO);
...
//				}
        ...
        updateBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    teacher = teacherService.updateStudent(updateDTO);
                    StudentReadOnlyDTO readOnlyDTO = mapToReadOnlyDTO(teacher);

                    JOptionPane.showMessageDialog(null, "Student with id: " + readOnlyDTO.getId() + " was updated", "Update",
    ...
    private void buildTable() {
        ...
        try {
            ...
            List<Student> teachers = teacherService.getStudentsByLastname(searchStr);
            ...
            for (StudentReadOnlyDTO teacherReadOnlyDTO : readOnlyDTOS) {
                vector = new Vector<>(3);
    ...
    private StudentReadOnlyDTO mapToReadOnlyDTO(Student teacher) {
        return new StudentReadOnlyDTO(teacher.getId(), teacher.getFirstname(), teacher.getLastname());
    }
}