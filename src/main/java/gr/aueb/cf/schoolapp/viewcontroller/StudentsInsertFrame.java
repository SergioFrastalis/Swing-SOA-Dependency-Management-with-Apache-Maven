...
public class StudentsInsertFrame extends JFrame {
    ...
    // Wiring
    private final ITeacherDAO studentDAO = new TeacherDAOImpl();
    private final ITeacherService studentService = new TeacherServiceImpl(studentDAO);
...
//						}
                    ...
                    student = studentService.insertTeacher(insertDTO);
                    TeacherReadOnlyDTO readOnlyDTO = mapToReadOnlyDTO(student);
    ...
    private TeacherReadOnlyDTO mapToReadOnlyDTO(Teacher student) {
        return new TeacherReadOnlyDTO(student.getId(), student.getFirstname(), student.getLastname());
    }
}